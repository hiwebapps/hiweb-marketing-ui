...
const PRODUCTION = [
  ...
  { name: 'Frentes de servicio', where: 'Páginas de servicio', href: '/sections#demo-service-focus' },
  { name: 'Propuesta de servicio', where: 'Páginas de servicio', href: '/sections#demo-service-pitch' },
  { name: 'Por qué Hiweb', where: 'Página de SEO', href: '/sections#demo-service-why' },
  { name: 'Planes de servicio', where: 'Página de SEO', href: '/sections#demo-service-plans' },
